...
function createThemeForCSS(vars = {}) {
    const _a = Object.assign({ primary: defaultPrimary, mainColors: generate(defaultPrimary), nc: '#d9d9d9', tc: 'rgb(51 51 51 / 85%)', tcD1: '#333', radius: '4px', bgColor: '#fff', bgColorSecondary: '#fff', placeholderColor: 'rgb(117, 117, 117)' }, vars), { mainColors } = _a, rest = __rest(_a, ["mainColors"]);
...
function setThemeStyleToDOM(style) {
    return;
}
...
const LS_IS_DARK_MODE_KEY = '__LS_IS_DARK_MODE_KEY__';
...
const isDarkMode = writable(LS.get(LS_IS_DARK_MODE_KEY) ||
    ( false
        ));
...
const LinkTypeSelect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"ls-wrap svelte-obzzk2"}"><section class="${"svelte-obzzk2"}">${escape(linksSchema[$selectedLinkType].name)}</section>
  ${ ``}
</div>`;
});
...
const SearchInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	hitoko = (_b = (_a = $res.data) === null || _a === void 0
	? void 0
	...
	return `<section class="${"svelte-3lfl0o"}">
  <input type="${"text"}"${add_attribute("maxlength", 2048, 0)}${add_attribute("value", displayValue, 0)}${add_attribute("spellcheck", false, 0)} autocomplete="${"off"}"${add_attribute("placeholder", placeholder, 0)} class="${"svelte-3lfl0o"}"${add_attribute("this", elInput, 1)}>
...
/* src/components/DarkMode.svelte generated by Svelte v3.31.0 */

const css$4 = {
	code: ".dark-mode-toggle.svelte-6qxuln.svelte-6qxuln{position:relative;cursor:pointer}.track.svelte-6qxuln.svelte-6qxuln{width:42px;height:24px;border-radius:24px;border:3px solid #d1d5da;transition:all 0.3s}.thumb.svelte-6qxuln.svelte-6qxuln{position:absolute;top:-2px;left:-2px;width:28px;height:28px;line-height:28px;text-align:center;border-radius:50%;background-color:#2f363d;transition:all 0.3s;color:yellow}.isdark.svelte-6qxuln .track.svelte-6qxuln{border-color:#43247f;background-color:rgba(110, 64, 201, 0.2)}.isdark.svelte-6qxuln .thumb.svelte-6qxuln{background-color:#6e40c9;transform:translateX(18px)}",
	map: "{\"version\":3,\"file\":\"DarkMode.svelte\",\"sources\":[\"DarkMode.svelte\"],\"sourcesContent\":[\"<span\\n  class=\\\"dark-mode-toggle\\\"\\n  class:isdark={$isDarkMode}\\n  on:click={handleOnToggle}>\\n  <div class=\\\"track\\\">\\n    <div class=\\\"thumb\\\">\\n      <Icon name=\\\"moon\\\" />\\n    </div>\\n  </div>\\n</span>\\n\\n<script>\\n  import { createThemeForCSS, setThemeStyleToDOM } from '@/shared/theme';\\n  import { isDarkMode } from '@/store';\\n  import Icon from './Icon.svelte';\\n\\n  $: {\\n    const cssArg = $isDarkMode\\n      ? {\\n          tc: '#c9d1d9',\\n          nc: '#c9d1d9',\\n          bgColor: '#21252d',\\n          bgColorSecondary: '#171c21',\\n          placeholderColor: '#9aa3ad',\\n        }\\n      : {};\\n    setThemeStyleToDOM(createThemeForCSS(cssArg));\\n  }\\n\\n  function handleOnToggle() {\\n    $isDarkMode = !$isDarkMode;\\n  }\\n</script>\\n\\n<style lang=\\\"less\\\">.dark-mode-toggle {\\n  position: relative;\\n  cursor: pointer;\\n}\\n.track {\\n  width: 42px;\\n  height: 24px;\\n  border-radius: 24px;\\n  border: 3px solid #d1d5da;\\n  transition: all 0.3s;\\n}\\n.thumb {\\n  position: absolute;\\n  top: -2px;\\n  left: -2px;\\n  width: 28px;\\n  height: 28px;\\n  line-height: 28px;\\n  text-align: center;\\n  border-radius: 50%;\\n  background-color: #2f363d;\\n  transition: all 0.3s;\\n  color: yellow;\\n}\\n.isdark .track {\\n  border-color: #43247f;\\n  background-color: rgba(110, 64, 201, 0.2);\\n}\\n.isdark .thumb {\\n  background-color: #6e40c9;\\n  transform: translateX(18px);\\n}\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAkCmB,iBAAiB,4BAAC,CAAC,AACpC,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,OAAO,AACjB,CAAC,AACD,MAAM,4BAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,IAAI,CACnB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,UAAU,CAAE,GAAG,CAAC,IAAI,AACtB,CAAC,AACD,MAAM,4BAAC,CAAC,AACN,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,IAAI,CACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,MAAM,CAClB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,OAAO,CACzB,UAAU,CAAE,GAAG,CAAC,IAAI,CACpB,KAAK,CAAE,MAAM,AACf,CAAC,AACD,qBAAO,CAAC,MAAM,cAAC,CAAC,AACd,YAAY,CAAE,OAAO,CACrB,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AAC3C,CAAC,AACD,qBAAO,CAAC,MAAM,cAAC,CAAC,AACd,gBAAgB,CAAE,OAAO,CACzB,SAAS,CAAE,WAAW,IAAI,CAAC,AAC7B,CAAC\"}"
};

const DarkMode = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let $isDarkMode = get_store_value(isDarkMode);
	...
	return `<span class="${["dark-mode-toggle svelte-6qxuln", $isDarkMode ? "isdark" : ""].join(" ").trim()}"><div class="${"track svelte-6qxuln"}"><div class="${"thumb svelte-6qxuln"}">${validate_component(Icon, "Icon").$$render($$result, { name: "moon" }, {}, {})}</div></div>
</span>`;
});
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<main class="${"svelte-1dczk3n"}"><div style="${"margin-top: 300px"}"></div>
  <div class="${"ma__darkmode-wrap svelte-1dczk3n"}">${validate_component(DarkMode, "DarkMode").$$render($$result, {}, {}, {})}</div>
  <div>${validate_component(Time, "Time").$$render($$result, {}, {}, {})}</div>
  <div class="${"ma__usually-wrap svelte-1dczk3n"}">${validate_component(RecentUsage, "RecentUsage").$$render($$result, {}, {}, {})}</div>
  <div class="${["ma__input-wrap svelte-1dczk3n",  ""].join(" ").trim()}"><div class="${"link-type-sl svelte-1dczk3n"}">${validate_component(LinkTypeSelect, "LinkTypeSelect").$$render($$result, {}, {}, {})}</div>
    <i class="${"divider-y svelte-1dczk3n"}"></i>
    <div class="${"search-input-cp svelte-1dczk3n"}">${validate_component(SearchInput, "SearchInput").$$render(
			$$result,
			{ this: inputIns },
			{
				this: $$value => {
    ...
    <button class="${"search-submit svelte-1dczk3n"}">${validate_component(Icon, "Icon").$$render($$result, { name: "search", size: 20 }, {}, {})}</button></div>
</main>`;
	} while (!$$settled);
